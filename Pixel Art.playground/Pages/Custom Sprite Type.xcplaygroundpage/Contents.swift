...
let person1 = PersonSprite(headColor: .brown, torsoColor: .green, legsColor: .red, leftArmUp: true, rightArmUp: true)
let person2 = PersonSprite(headColor: .white, torsoColor: .blue, legsColor: .brown, leftArmUp: true, rightArmUp: true)

for _ in 1 ... 30 {
    display.clear()
    
    person1.draw(x: person1X, y: 5)
    person2.draw(x: person2X, y: 25)
